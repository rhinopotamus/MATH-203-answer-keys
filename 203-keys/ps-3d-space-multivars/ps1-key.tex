...
\begin{enumerate}[leftmargin=0pt]
    ...
    \begin{enumerate}
        ...
        \begin{center}
        \includegraphics[width=0.5\textwidth]{203-keys/images/ideal-gas.png}
        \end{center}
    ...
    \begin{enumerate}
        ...
        \begin{center}
            \includegraphics[scale=0.09]{203-keys/images/geogebra-export.png}\\
        \end{center}
    ...
    \begin{enumerate}
        ...
        \end{red}
        \begin{center}
            \includegraphics[width=0.6\textwidth]{203-keys/images/9-1-17-level-curves.png}
        \end{center}
        ...
        \begin{red}
            ...
            \begin{center}
                \includegraphics[width=0.6\textwidth]{203-keys/images/9-1-17-traces.png}
            \end{center}
