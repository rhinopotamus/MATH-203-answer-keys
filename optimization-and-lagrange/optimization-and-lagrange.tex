...
\begin{enumerate}[leftmargin=0pt]
    ...
    \begin{center}
\includegraphics[width=0.3\textwidth]{./plot4-1.png}
\includegraphics[width=0.3\textwidth]{./plot4-2.png}
\includegraphics[width=0.3\textwidth]{./plot4-3.png}
    \end{center}
    ...
    \end{red}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{./wa-input.png}
        
        \includegraphics[width=0.7\textwidth]{./wa-output.png}
    \end{center}
    \begin{red}
